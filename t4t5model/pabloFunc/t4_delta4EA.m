function [V] = t4_delta4EA(params,spfr_data)

params = params.*[10,10,10,1,1,10,10,1,1,1, 10];
...
p.b = params(3)*(1 - exp(-effDur/params(11))); %expo  plateau, N(t) = No*(1- exp(-t/tau)).
p.b = p.b / p.Tre;
...
if spfr_data.cat_flag     
    ...
    t_ind = [t_ind(1:end-1);s_ind(end);t_ind(end)-1];
