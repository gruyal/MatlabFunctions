...
% This function has been adapted for G4 and therefore instead of generating a
% movie makes a pattern with a frame for every change and adds the posFunFac as the factor to use
% when creating the position function in createProtoclG4
%
% ASSUMPTIONS
...
for vv=1:length(stimB)
 ...
 protocolStruct.masksStruct = maskSt;
 protocolStruct.posFunFac = posFunFac;
