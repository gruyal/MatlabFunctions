function Panel_tcp_com(command, argument)
...
%             send_tcp( char([2 hex2dec('11') argument(1)]));
%         else
...
%         end
    ...
    case 'set_active_analog_channel'
...
%         send_tcp( char([2 hex2dec('11') argument(1)]));
    ...
    case 'set_mode'
        ...
        send_tcp( char([3  hex2dec('10') argument(1) argument(2)]));
    ...
    case 'address'
        ...
        send_tcp( char([3 255 argument(1) argument(2)]));
    ...
    case 'set_velfunc_id'
        ...
        send_tcp( char([3 hex2dec('20') argument(1) argument(2)]));
    ...
    case 'set_funcx_freq'
        ...
        send_tcp( char([3 hex2dec('25') dec2char(argument(1),2)]));
    ...
    case 'set_funcy_freq'
        ...
        send_tcp( char([3 hex2dec('30') dec2char(argument(1),2)]));
    ...
    case 'set_max_voltage'
        ...
        send_tcp(char([3 hex2dec('35') argument(1) argument(2)]));
        
    case 'set_analog_output_function' % invalid function
        if ~isequal(length(argument),2)||(~isnumeric(argument))
        ...
        send_tcp(char([3 hex2dec('31') dec2char(argument(1),1) dec2char(argument(2),1)]));
...
% five byte commands:
    case 'set_position'
        ...
        send_tcp([5 hex2dec('70') dec2char(argument(1)-1,2) dec2char(argument(2)-1,2)]);
...
% nine byte commands:
    case 'send_gain_bias'
        ...
        send_tcp( [9 hex2dec('01') signed_16Bit_to_char(argument(1)), signed_16Bit_to_char(argument(2)), signed_16Bit_to_char(argument(3)), signed_16Bit_to_char(argument(4))]);
    ...
    case 'send_laser_pattern'
        ...
        %Note: these are all signed arguments, so we need to convert to 2's complement if necessary
        send_tcp([62 arg125(1:62)]);  %send first 62 byte data
        pause(0.5);
        send_tcp([63 arg125(63:125)]); %send second 63 byte data
