function singleBarSt = generateAlignedSingleBarStwMinMaxDiffWandV(pStruct, pathFlag)
        ...
        for kk=1:length(uWid)
            ...
            for mm=1:length(uVal)
                ...
                if sum(relInd) == 1
                    ...
                    allBaseline = vertcat(allBaseline, mean(baseVals));
            ...
            for mm=1:length(uVal)
                ...
                if maxResp > baseSD * relFac
                    ...
                    if isempty(postMaxInd)
                        ...
                        singleBarSt(ii,jj,kk,mm).resp.FWHM = (postMaxInd - preMaxInd)/sampToMsFac;
                        singleBarSt(ii,jj,kk,mm).resp.FWHMInds = [preMaxInd, postMaxInd]; 
                    end
                ...
                if abs(minResp) > baseSD * (relFac-1) % since inhibition is smaller
