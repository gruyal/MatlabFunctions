function [alignStruct, varargout] = alignProtocolDataByTableOld2(pStruct, relVarName, meanTreshFlag)

% function alignStruct = alignProtocolDataByTableOld2(pStruct, relVarName)
%
% Added this to deal with the old data vesion where current is on channel 3
%
...
for ii=1:height(stimTable)
    ...
    alignStruct(ii).align = getAlignedStimDataByTableOld(pStruct, relTable.index, relVal);
