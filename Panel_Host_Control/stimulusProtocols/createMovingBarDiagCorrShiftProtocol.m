...
for vv=1:length(stimB)
    ...
    for ww=1:length(barW)
        ...
        for oo=1:length(shftOf)
            ...
            relDir = { [stPos, sftPos+addF+relOf]; [sftPos+addF+relOf, stPos]; ...
 ...
 tabVarNames =  {'index', 'value', 'width', 'span', 'stepDur', 'height', 'orient', 'dirInd', 'startPos', 'endPos', 'shiftPos', 'shiftOffset'};
