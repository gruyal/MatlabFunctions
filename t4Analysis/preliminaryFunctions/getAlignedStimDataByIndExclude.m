...
%
% This function is similar to getAlignedStimDataByInds only uses the excludes 
% specified reps form the mean calculation.  
%
% INPUT
% pStruct -             protocolStruct w/ stim field and data in it
% allIndRow -           full relInds field from the appropriate stim
...
indsSt = getStimInds(pStruct, allIndRow);
