function [traitVals, traitNames] = extractTrait(expSt, protIndices, traitName)
...
% traitNames -      (optional) is asked gives the name for each value in a
%                   cell array
...
traitDef.Brt = {'bright', 'dark', 'BonR', 'BonL', 'BonU', 'BonD', 'both'};
...
if nargout > 1
    relValNames = getfield(traitDef, traitName);
    traitNames = {relValNames{traitVals}};    
end
