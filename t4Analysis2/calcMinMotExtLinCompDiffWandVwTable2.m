function minMotSt = calcMinMotExtLinCompDiffWandVwTable2(mmStruct, sbStruct)

%function minMotSt = calcMinMotExtLinCompDiffWandV2(pStruct)
%
% This function is a modification of calcMinMotExtLinCompDiffWandVwTable.
% Major change is using generateAlignedSingleBarStwMinMaxDiffWandV2 for
% aligning singlebar data and alignProtocolDataByTable2 for the minMot data
% (mainly due to the different noise in the new round of experiments - more
% noisy baseline)
%
...
singleBarSt = generateAlignedSingleBarStwMinMaxDiffWandV2(sbStruct, 1);
...
alignSt = alignProtocolDataByTable2(mmStruct, {'sAppear', 'fAppear', 'sDisappear'});
